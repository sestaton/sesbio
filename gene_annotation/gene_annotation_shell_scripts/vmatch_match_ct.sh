...
vmerSearchFull=$cwd"/"$seqFile"_"$merLen"mer_"$qryFile"_vmatch_full.out"
vmerSearchIDs=$cwd"/"$seqFile"_"$merLen"mer_"$qryFile"_vmatch_IDs.txt"
vmerSearchIDsCt=$cwd"/"$seqFile"_"$merLen"mer_"$qryFile"_vmatch_IDs_ct.txt"
