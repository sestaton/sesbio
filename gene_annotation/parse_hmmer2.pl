...
#                                                                 |
# parse_hmmer2.pl - Get report or sequences from hmmer3
#_________________________________________________________________+
#                                                                 |
...
my $seqfile;
my $hmmname;
my $usage = "USAGE: parse_hmmer2.pl -i infile <-o outfile> <-s seqfile> <-h hmmname>
...
my $hmmerin = Bio::SearchIO->new(-file => "$infile", -format => 'hmmer');
