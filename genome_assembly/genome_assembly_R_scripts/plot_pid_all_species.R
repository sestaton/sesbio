...
# Ager
ager <- read.table("Ageratina_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Ann
hann <- read.table("Ann1238_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Dasy
dasy <- read.table("Dasyphyllum_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#gnaph
gnaph <- read.table("Gnaph_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Hport
hport <- read.table("Hport_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Hvert
hvert <- read.table("Hvert_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Saff
saff <- read.table("Saff_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#TKS
tks <- read.table("TKS_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#calyc
caly <- read.table("Calycera_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#gerb
gerb <- read.table("Gerbera_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Harg
harg <- read.table("Harg_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Hteph
hteph <- read.table("Hteph_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#Phoeb
phoeb <- read.table("Phoeb_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#sene
sene <- read.table("Senecio_scaffolds_HA383cp.bln",header=F,sep="\t")
...
#CP
cp <- read.table("Centrapallus_scaffolds_HA383cp.bln",header=F,sep="\t")
