...
blastall -p blastn -e 1e-5 -i build_30_over4kb.fasta -d ~/db/Repbase15.06 -o bld30_over4kb_repbase1506.bl7 -m7



perl ~/ePerl/parse_blast.pl -i bld30_over4kb_repbase1506.bl7 -f blastxml -o bld30_over4kb_repbase1506_parsed.txt 