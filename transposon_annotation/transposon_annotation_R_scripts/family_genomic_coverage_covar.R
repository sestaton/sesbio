...
ggplot(all_merged_finally, aes(x=mean, y=covar)) + 
theme_bw() + 
stat_smooth(method=loess,fill="lightblue") + 
geom_point(aes(color=ReadNum),size=2.5) + 
xlim(0,5) + 
ylim(-5,40) + 
geom_line(x=1,color="green") + 
geom_line(y=15,color="green") + 
xlab("Genomic Proportion") + 
ylab("Coefficient of Variation") + 
theme(axis.text.x = element_text(size = 16), 
      axis.text.y = element_text(size = 16), 
      axis.title.x = element_text(size = 18), 
      axis.title.y = element_text(size = 18)) + 
scale_color_manual(values=c("grey90","grey80","grey70","grey60","grey50","grey40","grey30","grey20","grey10","black"),
                   name="Percent Genome Coverage",
                   breaks=c("20000","220000","420000","620000","820000","1020000","1220000","1420000","1620000","1820000"),
                   labels=c("0.056","0.6","1.2","1.7","2.3","2.8","3.4","3.9","4.5","5.1"))
