...
#perl ~/github/sesbio/transposon_annotation/parse_mgblast.pl \
#-i ha412ho_1_1_self_mgblast_out.txt \
#-o ha412ho_1_1_self_mgblast_out_parsed.txt \
#-id 90.00 \
#-cov 0.15

#/home/jmblab/statonse/apps/seqgrapher/fgclust/clusters2graphs.R \
#-H ha412ho_1_self_mgblast_out_parsed.txt \
#-c ha412ho_1_self_mgblast_out_parsed.txt.cls \
#-p 4 \
#-s ha412ho_1_clusters