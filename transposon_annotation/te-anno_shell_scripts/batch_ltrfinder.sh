...
cd /home/jmblab/statonse/draft_jmblab_BACs/
perl ~/apps/dawgpaws/scripts/batch_ltrfinder.pl -i all_CGP_jmblab_BACs -o all_CGP_jmblab_BACs_bltrf_6-14 -c /home/jmblab/statonse/apps/dawgpaws/scripts/config/batch_ltrfinder.jcfg -f --verbose