...
#/home/jmblab/statonse/apps/gicl/mgblast -i ha412ho-short_IDs.fna.clean_nochloro_unique.fasta.1.1 -d ha412ho_1_1_unique -F "m D" -D 4 -p 85 -W18 -UT -X40 -KT -JF -v90000000 -b90000000 -C80 -H 320 -a 4 -o ha412ho_1_1_self_mgblast_out.txt
