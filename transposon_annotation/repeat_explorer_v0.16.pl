...
## TODO: turn off printing in R code and do it with Perl
##       final R routine is still printing "NULL" to the screen (need to capture dev.off()) <==== only in graphsing?
##
##       add R script for generating annotated barplot
