...
ager_sene_calyc <- merge(ager_sene, calyc.summ.f, all=T);
rm(ager_sene)
ager_sene_calyc_cp <- merge(ager_sene_calyc, cp.summ.f,all=T);
rm(ager_sene_calyc)
ager_sene_calyc_cp_dasy <- merge(ager_sene_calyc_cp, dasy.summ.f,all=T);
rm(ager_sene_calyc_cp)
ager_sene_calyc_cp_dasy_gerb <- merge(ager_sene_calyc_cp_dasy,gerb.summ.f,all=T);
rm(ager_sene_calyc_cp_dasy)
ager_sene_calyc_cp_dasy_gerb_gnaph <- merge(ager_sene_calyc_cp_dasy_gerb,gnap.summ.f,all=T);
rm(ager_sene_calyc_cp_dasy_gerb)
ager_sene_calyc_cp_dasy_gerb_gnaph_hann <- merge(ager_sene_calyc_cp_dasy_gerb_gnaph,hann.summ.f,all=T);
