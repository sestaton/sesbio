...
# lexical vars
my $usage = "$0 -i cls_dir_with_merges -f fasta -o outdir -r report -d repeat_blast_db -j repbase1801_full.json -c cls_file [-e 1e-5]\n\n";
my $indir;
my $outdir;
my $report;
my $database;
...
annotate_clusters($indir, $database, $json, $report, $outdir, $evalue, $seqct, $cls_tot); #repeat_explorer_v0.15.pl
