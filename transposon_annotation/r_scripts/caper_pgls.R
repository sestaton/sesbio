# script for testing associations between a character and a tree using the R package Caper
# NB: names in the comparative data set much match those in the tree
